<form method="POST" @submit.prevent="updateCrud(getCrudDetail.relplace.id)" id="updatePlace">
    @csrf
    @method('PUT')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="warehouse_id" id="warehouse" class="form-control" v-model="getCrudDetail.relplace.warehouse_id">
                    ...
                    <div class="form-group">
                        ...
                        <select name="locate_id" id="locate" class="form-control" v-model="getCrudDetail.relplace.locate_id">
                            <option value="0">Seleccione uno...</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="level_id" id="level" class="form-control" v-model="getCrudDetail.relplace.level_id">
                            <option value="0">Seleccione uno...</option>
