...
@section('title')
    <title>Prontoform At&t - Tipos de Usuarios</title>
@endsection

@section('content')
<main id="crud" role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4" crud="usertype">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <h1 class="h1">Tipos de Usuarios</h1>
    </div>
    <form @submit.prevent="createCrud" method="POST" id="createUserType" class="input-group mb-3">
        @csrf
        <input type="text" class="form-control" placeholder="Indicar tipo de usuario" name="nombre">
    ...
    <table id="Area_table" class="table display">
        <thead>
            <tr>
                <th>Tipos de usuarios disponibles</th>
                <th></th>
            </tr>
        </thead>
        <tbody>
